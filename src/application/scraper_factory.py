...
class ScraperFactory:
    ...
    def __init__(self, scrapers: list[ScraperPort] | None = None):
    ...
    def get_scrapers(
        self, active_sources: list[str] | None = None
    ) -> list[ScraperPort]:
    ...
    def get_scraper_by_source(self, source_name: str) -> ScraperPort | None:
    ...
    def build_search_urls(
        self, query: str, active_sources: list[str] | None = None
    ) -> list[tuple[str, str]]:
