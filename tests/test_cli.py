...
async def test_cli_loop_actions():
    ...
    offer1 = Offer(
        ...
        id=10,
        description="desc1",
        price=OfferPrice(price_min=100),
        location="loc1",
        fingerprint="fp1",
        urls=[],
    ...
    offer2 = Offer(
        ...
        id=20,
        description="desc2",
        price=OfferPrice(price_min=200),
        location="loc2",
        fingerprint="fp2",
        urls=[],
    ...
    offer3 = Offer(
        ...
        id=30,
        description="desc3",
        price=OfferPrice(price_min=300),
        location="loc3",
        fingerprint="fp3",
        urls=[],
        category=OfferCategory.JOB,
    ...
    offer4 = Offer(
        ...
        id=40,
        description="desc4",
        price=OfferPrice(price_min=400),
        location="loc4",
        fingerprint="fp4",
        urls=[],
        category=OfferCategory.REAL_ESTATE,
        ...
        with patch("src.cli.main.console.print") as mock_print:
            ...
            summary_call = next(
                (
                    c
                    for c in calls
                    if "Session Summary - Saved: 1, Rejected: 1, Skipped: 1" in str(c)
                ),
                None,
            )
